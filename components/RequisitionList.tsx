        ...
        {steps.map((step, index) => {
          ...
          return (
            <div key={index} className="relative flex-1 flex flex-col items-center group">
              ...
              <div 
                className={`relative z-10 w-7 h-7 sm:w-8 sm:h-8 rounded-full flex items-center justify-center border-2 transition-all duration-300 shadow-sm bg-white
                  ${isActive ? step.activeClass : 'bg-gray-100 border-gray-200 text-gray-300'}
                `}
              >
